...
<header>
	<div class="container">
		...
		<a onclick=""><img src="static/z/sc.png" draggable="false">加入收藏</a>
		
		<a target="_blank" href=""><img src="static/z/we.png" draggable="false">后台管理</a>
    ...
    <div class="course">
        <div class="container">
            ...
            <div class="course-info">
                ...
                <!--马上试听-->
                <a onclick="" target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=2580094677&amp;site=qq&amp;menu=yes">
